...
PUID_DEFAULT="1000"
GUID_DEFAULT="1000"
WATCH_INTERVAL_DEFAULT="40"
AUTOSTOP_TIMEOUT_EST_DEFAULT="240"
STARTUP_TIMEOUT_DEFAULT="180"
...
WATCH_INTERVAL=$(prompt "WATCH_INTERVAL" "$WATCH_INTERVAL_DEFAULT")
AUTOSTOP_TIMEOUT_EST=$(prompt "AUTOSTOP_TIMEOUT_EST" "$AUTOSTOP_TIMEOUT_EST_DEFAULT")
STARTUP_TIMEOUT=$(prompt "STARTUP_TIMEOUT" "$STARTUP_TIMEOUT_DEFAULT")
